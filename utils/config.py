...
def get_args():
    ...
    parser.add_argument('--scale', type = str, default = 'big')
    parser.add_argument('--timescale', type = int, default = 5)
    parser.add_argument('--timescale_type', type = str, default = 'bio')
    ...
    parser.add_argument('--diffusion_type', type = str, default = 'non-uniform')
    ...
    parser.add_argument('--mixer_dropout_prob', type = float, default = 0.2) #3 only used for mlp mixers 
    parser.add_argument('--pde_reg_weight', type = float, default = 0.001)
    parser.add_argument('--val_time_offsets', type = int, default = 0)
    parser.add_argument('--use_genes', type = str, default = 'all')
    parser.add_argument('--preprocess_gex', type = str, default = 'True')
    parser.add_argument('--normalize', type = str, default = 'mediannorm')
